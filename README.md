...
## Personnalisation
- Accueil : la photo de fond est `assets/img/hero-silo-2400.jpg` (et `-1200.jpg` pour les petits écrans), bichromie kraft générée depuis « Sources plans/silo hero.jpg ». Pour la changer, remplacez ces deux fichiers (JPEG, ratio 3:2 environ, 2400 px de large) ; le logo, la tagline et le bouton « Découvrir » restent centrés par-dessus.
